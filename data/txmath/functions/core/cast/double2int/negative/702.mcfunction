#> txmath:core/cast/double2int/negative/702
# [2^700,2^704)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/703
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/701
