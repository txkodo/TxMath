#> txmath:core/cast/double2int/negative/668
# [2^664,2^672)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/670
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/666
