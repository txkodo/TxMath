#> txmath:core/cast/double2int/negative/550
# [2^548,2^552)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/551
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/549
