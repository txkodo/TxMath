#> txmath:core/cast/double2int/negative/-645
# [2^-647,2^-643)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-644
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-646
