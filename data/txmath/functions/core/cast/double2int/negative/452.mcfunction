#> txmath:core/cast/double2int/negative/452
# [2^448,2^456)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/454
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/450
