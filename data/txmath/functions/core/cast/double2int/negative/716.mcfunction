#> txmath:core/cast/double2int/negative/716
# [2^712,2^720)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/718
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/714
