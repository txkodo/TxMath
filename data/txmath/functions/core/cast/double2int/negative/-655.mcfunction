#> txmath:core/cast/double2int/negative/-655
# [2^-671,2^-639)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-647
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-663
