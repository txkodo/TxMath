#> txmath:core/cast/double2int/negative/-613
# [2^-615,2^-611)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-612
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-614
