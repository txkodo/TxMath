#> txmath:core/cast/double2int/negative/622
# [2^620,2^624)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/623
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/621
