#> txmath:core/cast/double2int/negative/-631
# [2^-639,2^-623)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-627
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-635
