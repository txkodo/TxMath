#> txmath:core/cast/double2int/negative/480
# [2^448,2^512)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/496
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/464
