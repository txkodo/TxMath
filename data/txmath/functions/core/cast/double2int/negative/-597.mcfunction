#> txmath:core/cast/double2int/negative/-597
# [2^-599,2^-595)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-596
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-598
