#> txmath:core/cast/double2int/negative/518
# [2^516,2^520)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/519
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/517
