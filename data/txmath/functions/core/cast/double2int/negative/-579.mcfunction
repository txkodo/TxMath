#> txmath:core/cast/double2int/negative/-579
# [2^-583,2^-575)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-577
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-581
