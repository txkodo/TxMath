#> txmath:core/cast/double2int/negative/-635
# [2^-639,2^-631)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-633
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-637
