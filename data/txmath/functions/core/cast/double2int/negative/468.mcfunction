#> txmath:core/cast/double2int/negative/468
# [2^464,2^472)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/470
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/466
