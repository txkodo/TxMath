#> txmath:core/cast/double2int/negative/672
# [2^640,2^704)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/688
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/656
