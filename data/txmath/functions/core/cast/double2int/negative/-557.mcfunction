#> txmath:core/cast/double2int/negative/-557
# [2^-559,2^-555)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-556
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-558
