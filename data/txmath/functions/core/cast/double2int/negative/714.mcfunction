#> txmath:core/cast/double2int/negative/714
# [2^712,2^716)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/715
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/713
