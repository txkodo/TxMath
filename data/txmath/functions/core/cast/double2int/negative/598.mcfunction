#> txmath:core/cast/double2int/negative/598
# [2^596,2^600)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/599
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/597
