#> txmath:core/cast/double2int/negative/-659
# [2^-663,2^-655)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-657
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-661
