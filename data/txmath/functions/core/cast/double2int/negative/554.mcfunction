#> txmath:core/cast/double2int/negative/554
# [2^552,2^556)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/555
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/553
