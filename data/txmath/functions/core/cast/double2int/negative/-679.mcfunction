#> txmath:core/cast/double2int/negative/-679
# [2^-687,2^-671)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-675
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-683
