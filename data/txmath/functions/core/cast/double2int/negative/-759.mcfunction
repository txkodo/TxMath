#> txmath:core/cast/double2int/negative/-759
# [2^-767,2^-751)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-755
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-763
