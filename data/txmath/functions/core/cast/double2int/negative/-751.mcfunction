#> txmath:core/cast/double2int/negative/-751
# [2^-767,2^-735)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/negative/-743
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/negative/-759
