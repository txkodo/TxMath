#> txmath:core/cast/double2int/positive/678
# [2^676,2^680)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/679
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/677
