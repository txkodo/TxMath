#> txmath:core/cast/double2int/positive/-661
# [2^-663,2^-659)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-660
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-662
