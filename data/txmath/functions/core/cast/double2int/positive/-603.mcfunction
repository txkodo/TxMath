#> txmath:core/cast/double2int/positive/-603
# [2^-607,2^-599)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-601
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-605
