#> txmath:core/cast/double2int/positive/-741
# [2^-743,2^-739)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-740
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-742
