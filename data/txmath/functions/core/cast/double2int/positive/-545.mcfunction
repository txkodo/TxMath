#> txmath:core/cast/double2int/positive/-545
# [2^-547,2^-543)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-544
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-546
