#> txmath:core/cast/double2int/positive/612
# [2^608,2^616)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/614
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/610
