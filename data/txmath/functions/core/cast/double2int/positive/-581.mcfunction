#> txmath:core/cast/double2int/positive/-581
# [2^-583,2^-579)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-580
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-582
