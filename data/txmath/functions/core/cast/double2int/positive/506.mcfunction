#> txmath:core/cast/double2int/positive/506
# [2^504,2^508)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/507
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/505
