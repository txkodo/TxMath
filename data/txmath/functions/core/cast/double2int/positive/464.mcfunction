#> txmath:core/cast/double2int/positive/464
# [2^448,2^480)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/472
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/456
