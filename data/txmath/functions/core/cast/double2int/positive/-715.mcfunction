#> txmath:core/cast/double2int/positive/-715
# [2^-719,2^-711)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-713
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-717
