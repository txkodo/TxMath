#> txmath:core/cast/double2int/positive/-611
# [2^-615,2^-607)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-609
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-613
