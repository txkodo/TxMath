#> txmath:core/cast/double2int/positive/-703
# [2^-767,2^-639)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-671
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-735
