#> txmath:core/cast/double2int/positive/-755
# [2^-759,2^-751)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-753
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-757
