#> txmath:core/cast/double2int/positive/-773
# [2^-775,2^-771)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-772
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-774
