#> txmath:core/cast/double2int/positive/-739
# [2^-743,2^-735)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-737
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-741
