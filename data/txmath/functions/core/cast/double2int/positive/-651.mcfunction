#> txmath:core/cast/double2int/positive/-651
# [2^-655,2^-647)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-649
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-653
