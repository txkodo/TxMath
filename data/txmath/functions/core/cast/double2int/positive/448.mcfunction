#> txmath:core/cast/double2int/positive/448
# [2^384,2^512)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/480
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/416
