#> txmath:core/cast/double2int/positive/640
# [2^512,2^768)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/704
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/576
