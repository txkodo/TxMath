#> txmath:core/cast/double2int/positive/-747
# [2^-751,2^-743)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-745
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-749
