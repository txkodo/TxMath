#> txmath:core/cast/double2int/positive/-525
# [2^-527,2^-523)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-524
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-526
