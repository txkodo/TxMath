#> txmath:core/cast/double2int/positive/-753
# [2^-755,2^-751)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-752
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-754
