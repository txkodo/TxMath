#> txmath:core/cast/double2int/positive/604
# [2^600,2^608)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/606
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/602
