#> txmath:core/cast/double2int/positive/-729
# [2^-731,2^-727)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-728
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-730
