#> txmath:core/cast/double2int/positive/698
# [2^696,2^700)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/699
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/697
