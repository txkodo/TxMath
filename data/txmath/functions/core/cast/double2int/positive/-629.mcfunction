#> txmath:core/cast/double2int/positive/-629
# [2^-631,2^-627)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-628
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-630
