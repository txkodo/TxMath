#> txmath:core/cast/double2int/positive/-535
# [2^-543,2^-527)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-531
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-539
