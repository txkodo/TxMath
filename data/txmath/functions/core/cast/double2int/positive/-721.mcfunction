#> txmath:core/cast/double2int/positive/-721
# [2^-723,2^-719)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-720
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-722
