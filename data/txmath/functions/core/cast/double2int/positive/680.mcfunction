#> txmath:core/cast/double2int/positive/680
# [2^672,2^688)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/684
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/676
