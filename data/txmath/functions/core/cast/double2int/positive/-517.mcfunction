#> txmath:core/cast/double2int/positive/-517
# [2^-519,2^-515)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-516
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-518
