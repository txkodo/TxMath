#> txmath:core/cast/double2int/positive/508
# [2^504,2^512)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/510
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/506
