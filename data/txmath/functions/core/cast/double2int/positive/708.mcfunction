#> txmath:core/cast/double2int/positive/708
# [2^704,2^712)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/710
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/706
