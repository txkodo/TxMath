#> txmath:core/cast/double2int/positive/-707
# [2^-711,2^-703)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-705
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-709
