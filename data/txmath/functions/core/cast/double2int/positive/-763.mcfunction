#> txmath:core/cast/double2int/positive/-763
# [2^-767,2^-759)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-761
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-765
