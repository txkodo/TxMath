#> txmath:core/cast/double2int/positive/-725
# [2^-727,2^-723)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-724
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-726
