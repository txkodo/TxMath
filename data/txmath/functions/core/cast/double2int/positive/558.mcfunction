#> txmath:core/cast/double2int/positive/558
# [2^556,2^560)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/559
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/557
