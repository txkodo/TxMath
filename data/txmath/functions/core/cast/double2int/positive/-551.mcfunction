#> txmath:core/cast/double2int/positive/-551
# [2^-559,2^-543)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-547
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-555
