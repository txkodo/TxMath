#> txmath:core/cast/double2int/positive/616
# [2^608,2^624)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/620
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/612
