#> txmath:core/cast/double2int/positive/-735
# [2^-767,2^-703)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-719
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-751
