#> txmath:core/cast/double2int/positive/-639
# [2^-767,2^-511)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-575
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-703
