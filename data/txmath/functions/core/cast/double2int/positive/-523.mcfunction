#> txmath:core/cast/double2int/positive/-523
# [2^-527,2^-519)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-521
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-525
