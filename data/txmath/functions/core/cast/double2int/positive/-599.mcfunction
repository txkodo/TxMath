#> txmath:core/cast/double2int/positive/-599
# [2^-607,2^-591)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-595
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-603
