#> txmath:core/cast/double2int/positive/-593
# [2^-595,2^-591)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-592
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-594
