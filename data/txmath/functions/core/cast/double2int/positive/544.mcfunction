#> txmath:core/cast/double2int/positive/544
# [2^512,2^576)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/560
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/528
