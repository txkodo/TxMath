#> txmath:core/cast/double2int/positive/578
# [2^576,2^580)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/579
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/577
