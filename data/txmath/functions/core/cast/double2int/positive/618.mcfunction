#> txmath:core/cast/double2int/positive/618
# [2^616,2^620)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/619
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/617
