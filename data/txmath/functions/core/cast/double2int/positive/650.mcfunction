#> txmath:core/cast/double2int/positive/650
# [2^648,2^652)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/651
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/649
