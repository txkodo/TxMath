#> txmath:core/cast/double2int/positive/-673
# [2^-675,2^-671)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-672
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-674
