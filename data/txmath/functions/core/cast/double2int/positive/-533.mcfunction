#> txmath:core/cast/double2int/positive/-533
# [2^-535,2^-531)
# @internal
...
execute if score $x txmath matches 1.. run function txmath:core/cast/double2int/positive/-532
execute if score $x txmath matches 0 run function txmath:core/cast/double2int/positive/-534
